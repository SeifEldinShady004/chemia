...
int PyramBoard::check_status()
{
    int a, b, c, d;

    if ((board[1][0] == 'x' && board[1][1] == 'x' && board[1][2] == 'x') || (board[0][0] == 'x' && board[1][0] == 'x' && board[2][0] == 'x')
    || (board[0][0] == 'x' && board[1][2] == 'x' && board[2][4] == 'x')||(board[0][0] == 'x' && board[1][1] == 'x' && board[2][2] == 'x'))
    {
        a=2;
...
int PyramBoard::minimax(int& x, int& y, bool isMaximizing, bool firstTime)
{
